...
def upload_phsyphone(video_path:str, description:str, draft:bool=False, photo_mode:bool=False, only_me:bool=False, lang:str="en"):
    ...
    #exit()
    # Upload to TikTok
    uploader_class.upload_tiktok(description=description, draft=draft, photo_mode=photo_mode, only_me=only_me, sound=False, lang=lang)
    if lang != "en":
        return
    # run insta
...
if __name__ == "__main__":
    ...
    # exit()
    upload_phsyphone("/Users/jonathanstoff/Desktop/Scripts/AIClipCreator/test_files/clip_SXoQ5gJLJdY.mp4", "This is a test description", draft=False, photo_mode=False, only_me=True, lang="es")